...
const BAR = "bg-muted/70 dark:bg-[#262626]/80 backdrop-blur-md";
const BAR_TEXT = "text-muted dark:text-[#262626]/80";
...
const SIZES = {
  ...
  sm: {
    label: "gap-1.5 px-3.5 py-2 text-[13px] leading-4 [&_svg]:size-3.5 font-medium",
    radius: 10,
    separation: 16,
  },
  md: {
...
function NavLabel({
  ...
  const props = {
    ...
    className: cn(
      "flex cursor-pointer items-center whitespace-nowrap font-medium [&_svg]:shrink-0 select-none",
      isActive ? FADE_IN : FADE_OUT,
      SIZES[size].label,
      !isActive && "text-foreground/80 dark:text-muted-foreground/90 hover:text-foreground",
    ),
